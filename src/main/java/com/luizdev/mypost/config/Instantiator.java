...
public class Instantiator implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
       ...
       Product p1 = new Product(null, "TV", 2800.0, "A good TV");
       Product p2 = new Product(null, "Videogame", 1100.0, "A funny Game");

       productRepository.saveAll(Arrays.asList(p1,p2));

       Seller seller = new Seller(null, "Seller1", "seller@gmail.com", "s123", "1234-4567", Arrays.asList(p1,p2));
